...
},{"../../vendor/vendor":18,"./ItemView":3}],2:[function(require,module,exports){
'use strict';
...
var _filterInput = require('../templates/filter-input.jst');
...
var FilterInputView = Mn.View.extend({
	template: _filterInput2.default,
	...
	onDataEntered: function onDataEntered() {
		//Filter the menu
...
exports.default = FilterInputView;

},{"../templates/filter-input.jst":9,"backbone":15,"backbone.marionette":13}],3:[function(require,module,exports){
'use strict';
...
var _menu = require('../templates/menu.jst');

var _menu2 = _interopRequireDefault(_menu);

var _ProjectGroupCollectionView = require('./ProjectGroupCollectionView.js');

var _ProjectGroupCollectionView2 = _interopRequireDefault(_ProjectGroupCollectionView);

var _FilterInputView = require('./FilterInputView.js');

var _FilterInputView2 = _interopRequireDefault(_FilterInputView);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Bb = require('backbone');

var ProjectGroupModel = new Bb.Model();
...
exports.default = _vendor.Marionette.View.extend({
	...
	onRender: function onRender() {
		var projectGroupCollectionView = new _ProjectGroupCollectionView2.default({
			collection: list
		});
		this.showChildView('region1', projectGroupCollectionView);
		this.showChildView('region2', new _FilterInputView2.default());
	},
	childViewEvents: {
...
},{"../../vendor/vendor":18,"../templates/menu.jst":10,"./FilterInputView.js":2,"./ProjectGroupCollectionView.js":5,"backbone":15}],4:[function(require,module,exports){
'use strict';
...
var _ProjectView = require('./ProjectView.js');

var _ProjectView2 = _interopRequireDefault(_ProjectView);

var _projectGroup = require('../templates/project-group.jst');
...
var ProjectCollectionView = _vendor.Marionette.CollectionView.extend({
  className: 'project',
  template: _projectGroup2.default,
  childViewContainer: '.projects-target',
  childView: _ProjectView2.default,
  regions: {
    region1: '.projects-target'
  }
});

exports.default = ProjectCollectionView;

},{"../../vendor/vendor":18,"../templates/project-group.jst":11,"./ProjectView.js":7,"backbone":15}],5:[function(require,module,exports){
'use strict';
...
var _ProjectGroupView = require('./ProjectGroupView.js');

var _ProjectGroupView2 = _interopRequireDefault(_ProjectGroupView);
...
var ProjectGroupCollectionView = _vendor.Marionette.CollectionView.extend({
	className: 'project-group',
	template: _projectGroup2.default,
	childViewContainer: '.projects-container',
	childView: _ProjectGroupView2.default,
	regions: {
		region1: '.projects-target'
	}
});

exports.default = ProjectGroupCollectionView;

},{"../../vendor/vendor":18,"../templates/project-group.jst":11,"./ProjectGroupView.js":6,"backbone":15}],6:[function(require,module,exports){
'use strict';
...
var _ProjectCollectionView = require('./ProjectCollectionView.js');

var _ProjectCollectionView2 = _interopRequireDefault(_ProjectCollectionView);
...
var ProjectGroupView = _vendor.Marionette.View.extend({
  //tagName: 'ul',
  className: 'project-group',
  template: _projectGroup2.default,
  //childViewContainer: '.projects-target',
  ...
  onRender: function onRender() {
    this.showChildView('region1', new _ProjectCollectionView2.default({
...
exports.default = ProjectGroupView;

},{"../../vendor/vendor":18,"../templates/project-group.jst":11,"./ProjectCollectionView.js":4,"backbone":15}],7:[function(require,module,exports){
'use strict';
...
var _project = require('../templates/project.jst');
...
},{"../templates/project.jst":12,"backbone":15,"backbone.marionette":13}],8:[function(require,module,exports){
'use strict';
...
},{"../vendor/vendor":18,"./components/App":1}],9:[function(require,module,exports){
var _ = require('underscore');
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<input type="text" class="filter-input" autofocus="true"><input type="hidden" class="current_y" value="0">';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<nav class="navbar navbar-default navbar-static-top"> <div class="container"> <div class="navbar-header"> <a class="navbar-brand" href="/"> ITSI </a> </div> <div class="collapse navbar-collapse" id="app-navbar-collapse"> <ul class="nav navbar-nav"> &nbsp; </ul> <ul class="nav navbar-nav navbar-right"> <li><a href="#">Game</a></li> <li class="dropdown"> <a href="#" class="dropdown-toggle dropbtn" data-toggle="dropdown" role="button" aria-expanded="false"> Go to projects </a> <ul class="dropdown-content dropdown-menu" role="menu"> <li class="padded-8"> <div id="filter"> <img src="/search-icon.png"> <div id="filter-target"></div> </div> </li> <li> <ul class="projects-container"> </ul> </li> </ul> </li> <li><a href="#">Products</a></li> </ul> </div> </div> </nav>';
}
return __p;
};
...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<li class="project-group"> <div class="group-image"> <img src="'+
((__t=( image.link ))==null?'':_.escape(__t))+
'"> </div> <div class="projects"> <div class="list-heading"><a href="'+
((__t=( url ))==null?'':_.escape(__t))+
'" class="visible">'+
((__t=( name ))==null?'':_.escape(__t))+
'</a></div> <ul class="projects-target"> </ul> <div class="btn-add-group">+ Add Group</div> </div> </li>';
}
return __p;
};
...
},{"backbone":15,"backbone.radio":14,"underscore":17}],14:[function(require,module,exports){
...
},{"backbone":15,"underscore":17}],15:[function(require,module,exports){
(function (global){
//     Backbone.js 1.3.3
...
},{"backbone":15,"backbone.marionette":13,"jquery":16,"underscore":17}]},{},[8]);
